...
INSERT INTO `rol` VALUES (1,'SuperAdmin'),(2,'Contador'),(3,'Cliente');
...
CREATE TABLE `tarea_metadata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) NOT NULL,
  `esPeriodica` tinyint(4) NOT NULL DEFAULT '0',
...
INSERT INTO `tarea_metadata` VALUES (1,'Liquidar IVA',0,1,NULL),(2,'Liquidar IVA 2015',0,1,1);
...
INSERT INTO `usuario` VALUES (1,2,'contador','contador',1,1),(2,1,'admin','admin',1,1),(3,3,'cliente','cliente',1,1);
