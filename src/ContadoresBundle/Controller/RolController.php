...
use ContadoresBundle\Form\RolType;
use ContadoresBundle\Form\RolFilterType;
...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('ContadoresBundle:Rol:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new RolFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('ContadoresBundle:Rol')->createQueryBuilder('e');
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($filterForm->isValid()) {
                ...
                $session->set('RolControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('RolControllerFilter')) {
                $filterData = $session->get('RolControllerFilter');
                $filterForm = $this->createForm(new RolFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('rol', array('page' => $page));
        };
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ContadoresBundle:Rol:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ContadoresBundle:Rol')->find($id);
        ...
        return $this->render('ContadoresBundle:Rol:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ContadoresBundle:Rol:edit.html.twig', array(
            'entity'      => $entity,
